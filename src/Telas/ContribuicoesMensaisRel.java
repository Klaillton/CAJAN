 ...
 * @author Klaillton
 */
public class ContribuicoesMensaisRel extends javax.swing.JFrame {

    /**
     * Creates new form ContribuicoesMentais
     */
    public ContribuicoesMensaisRel() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Contribuições Mensais");
...
//            rel.gerarRelatorio("C:\\cajan\\relatorios" + File.separator + "contribuicoes_mensais", pesList);
            String query = "SELECT * FROM Pagamento p"
                    ...
                    + " WHERE p.identificador <> '' "
                    + " AND p.data_pag BETWEEN " + Util.getDateUtilUSUnformat(dtinicial.getText()) 
