 ...
 * @author Klaillton
 */
public class EventosEPromocoes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Expectativa de arrecadação:");
    ...
    private void salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarActionPerformed
        ...
        e.setExpectativa(Double.parseDouble(expectativa.getText().replaceAll(",", ".")));
        e.setArrecadacao(Double.parseDouble("0.0"));
    ...
    private void buscarCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarCodigoActionPerformed
        ...
        try {
            ...
            if (e != null) {
                ...
                expectativa.setText(e.getExpectativa().toString());
                switch (e.getCont()) {
                    case 0:
...
//        System.out.println("Preencher tabela invocado!");
        ...
        String[] Colunas = new String[]{"Codigo", "Tipo", "Nome", "Inicio", "Fim", "Expectativa"
        };
...
//            pesList.first();
        ...
        jTabelaEventos.getColumnModel().getColumn(3).setPreferredWidth(150); //Data Fim
