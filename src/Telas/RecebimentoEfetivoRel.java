 ...
 * @author Klaillton
 */
public class RecebimentoEfetivoRel extends javax.swing.JFrame {

    /**
     * Creates new form ExpectativaRecebimentoRel
     */
    public RecebimentoEfetivoRel() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String query = "select"
                    ...
                    + " WHERE p.data_pag BETWEEN " + Util.getDateUtilUSUnformat(dtinicial.getText())
